...
describe("Store", function()
  ...
  it("Write returns the filename", function()
    ...
    assert(string.find(file, ".*/tasko.nvim/.*tasko%-1.md$") ~= nil, "wrong filename returned: " .. file)
  ...
  it("Considers description updates", function()
    ...
    assert(loaded_task.description == "\nnew description", "description! " .. vim.inspect(loaded_task))
    delete_test_file(file)
  end)
  ...
  it("loads a task from path", function()
    ...
    assert(loaded_task.description == "\nmy description", "description! " .. vim.inspect(loaded_task))
