...
describe("Store", function()
	function delete_test_files(files)
		Path:new(files.task_file):rm()
		Path:new(files.task_description_file):rm()
	end

	it("Write returns two files per task", function()
		...
		assert(string.find(files1.task_file, "json$") ~= nil, "no json file found")
		assert(string.find(files2.task_file, "json$") ~= nil, "no json file found")
		assert(string.find(files3.task_file, "json$") ~= nil, "no json file found")
		assert(string.find(files1.task_description_file, "md$") ~= nil, "no markdown file found")
		assert(string.find(files2.task_description_file, "md$") ~= nil, "no markdown file found")
		assert(string.find(files3.task_description_file, "md$") ~= nil, "no markdown file found")
		delete_test_files(files1)
		delete_test_files(files2)
		delete_test_files(files3)
	end)
	...
	it("Lists two files per task in one table", function()
		...
		for i = 1, 2, 3 do
			assert(string.find(task_list[tostring(i)].task_file, "json$") ~= nil, "no json file found")
			assert(string.find(task_list[tostring(i)].task_description_file, "md$") ~= nil, "no markdown file found")
		end
		delete_test_files(files1)
		delete_test_files(files2)
		delete_test_files(files3)
